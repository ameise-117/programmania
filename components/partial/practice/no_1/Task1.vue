	...
	.task
		svg.svg(xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="344" height="52" viewBox="0 -50 344 52")
			g(transform="translate(-121 -282)")
				...
				text(transform="translate(145 333)" fill="#707070" font-size="12" font-family="HiraginoSans-W3, Hiragino Sans")
					tspan(x="-24" y="0") スタート
				text(transform="translate(445 333)" fill="#707070" font-size="12" font-family="HiraginoSans-W3, Hiragino Sans")
