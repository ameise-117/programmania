	...
	.task
		svg.svg(xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="258.5" height="180.306" viewBox="0 0 258.5 180.306")
			g(transform="translate(-197 -1231.012)")
				...
				rect(ref="routeEl1" width="40" height="28.85" transform="translate(332.033 1292.46) rotate(45)" fill="none")
				rect(ref="goalEl" width="40" height="28.85" transform="translate(402.796 1362.634) rotate(45)" fill="none")
</template>
