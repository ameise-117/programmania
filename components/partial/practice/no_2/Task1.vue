	...
	.task
		svg.svg(xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="258.5" height="180.306" viewBox="0 0 258.5 180.306")
			g(transform="translate(-197 -1231.012)")
				...
				text(transform="translate(221 1262)" fill="#707070" font-size="12")
					tspan(x="-24" y="0") スタート
				text(transform="translate(369 1404)" fill="#707070" font-size="12")
					tspan(x="-17.58" y="0") ゴール
				text(transform="translate(313 1281)" fill="#c1c1bd" font-size="12")
